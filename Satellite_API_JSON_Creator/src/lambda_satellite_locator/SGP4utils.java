...
{
    public static double pi = SGP4unit_cssi.pi;
     ...
     */
    public static boolean readTLEandIniSGP4(String satName, String line1, String line2, char opsmode, SGP4unit_cssi.Gravconsttype whichconst, SGP4SatData satrec)
    {
...
//        int cardnumb, j; // numb,
        ...
        double[] temp = SGP4unit_cssi.getgravconst(whichconst);
        tumin = temp[0];
//        mu = temp[1];
...
//        j3oj2 = temp[7];
        ...
        boolean result = SGP4unit_cssi.sgp4init(whichconst, opsmode, satrec.satnum,
