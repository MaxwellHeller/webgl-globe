...
public class SGP4verification
{
    public static void main(String[] args)
    {
        ...
        SGP4unit_cssi.Gravconsttype gravconsttype = SGP4unit_cssi.Gravconsttype.wgs72;
        ...
        // get constants -------------------------------
        double[] gtt = SGP4unit_cssi.getgravconst(gravconsttype);//, tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2 );
        double tumin = gtt[0];
        double mu = gtt[1];
        ...
        try
        {
            ...
            while((strLine1 = br.readLine()) != null)
            {
                if(!strLine1.startsWith("#")) // ignore lines starting with #
                {
                    ...
                    SGP4unit_cssi.sgp4(satrec, 0.0, ro, vo);
                    ...
                    while((tsince < stopmfe) && (satrec.error == 0))
                    {
                        ...
                        SGP4unit_cssi.sgp4(satrec, tsince, ro, vo);
